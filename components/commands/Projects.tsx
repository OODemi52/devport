        ...
        <li>
          <li>
            <p>
              ...
              automates bulk image uploads and improves workflow efficiency
              across multiple channels.
              <br />
              <em>
                Technologies Used: Next.js, TypeScript, Node.js, MongoDB,
                PostHog, AWS
              </em>
            </p>
          </li>
          ...
          <li>
            <p>
              ...
              <br />
              Automated scripture and lyric extraction tool that
              reverse-engineers SQLite databases and generates structured
              outputs for worship service planning.
              <br />
